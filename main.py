...
def write_markdown_report(report: dict, report_path: str):
    ...
    with open(report_path, "w") as f:
        # ── Header ──
        f.write(f"# 📊 Biopharma AutoResearch Report\n")
        ...
        # ── Clinical Trials ──
        f.write("## 2. Clinical Trials Pipeline\n\n")
        ...
        # ── Heuristic POS ──
        f.write("## 3. Phase-Based Heuristic Analysis (Epi-Model)\n\n")
        ...
        # ── Literature Review ──
        f.write("## 4. Deep Literature Review (PubMed AutoResearch)\n\n")
        f.write(lit)
        f.write("\n\n---\n\n")
        
        # ── AI POS ──
        f.write("## 5. AI-Enhanced Probability of Success\n\n")
        ...
        # ── Valuation ──
        f.write("## 6. Epi-Model Valuation (rNPV)\n\n")
        ...
        # ── Footer ──
        f.write("---\n\n")
        f.write("*This report was generated by the Biopharma AutoResearcher pipeline. ")
        f.write("Data sources: ClinicalTrials.gov, openFDA, PubMed (NIH), Yahoo Finance. ")
        f.write("AI analysis powered by Google Gemini. This is not financial advice.*\n")
